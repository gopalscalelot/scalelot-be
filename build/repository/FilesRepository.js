...
let FilesRepository = class FilesRepository {
    async saveFiles(files) {
        ...
        const filesList = await FileEntity_1.default.insertMany(AppUtils_1.default.nullPropsRemover((0, class_transformer_1.instanceToPlain)(files)));
        return (0, class_transformer_1.plainToInstance)(FileDTO_1.default, filesList, { excludeExtraneousValues: true });
    }
};
