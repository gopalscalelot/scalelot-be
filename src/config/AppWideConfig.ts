...
export default class AppWideConfig {
    ...
    private configureRobots() {
        ...
        this.app.use(robots([
            {
                UserAgent: '*',
                Disallow: ['https://scalelot.com/assets/images/favicon/',
                    'https://scalelot.com/assets/css/font-awesome/all.min.css',
                    'https://scalelot.com/assets/css/flaticon/flaticon.css',
                    'https://scalelot.com/assets/css/bootstrap/bootstrap.min.css',
                    'https://scalelot.com/assets/css/owl-carousel/owl.carousel.min.css',
                    'https://scalelot.com/assets/css/swiper/swiper.min.css',
                    'https://scalelot.com/assets/css/animate/animate.min.css',
                    'https://scalelot.com/assets/css/magnific-popup/magnific-popup.css',
                    'https://scalelot.com/assets/css/style.css',
                    'https://scalelot.com/assets/js/jquery-3.6.0.min.js',
                    'https://scalelot.com/assets/js/popper/popper.min.js',
                    'https://scalelot.com/assets/js/bootstrap/bootstrap.min.js',
                    'https://scalelot.com/assets/images/',
                    'https://scalelot.com/assets/images/svg/',
                    'https://scalelot.com/assets/images/service/',
                    'https://scalelot.com/assets/js/jquery.appear.js',
                    'https://scalelot.com/assets/js/swiper/swiper.min.js',
                    'https://scalelot.com/assets/js/swiperanimation/SwiperAnimation.min.js',
                    'https://scalelot.com/assets/js/counter/jquery.countTo.js',
                    'https://scalelot.com/assets/js/owl-carousel/owl.carousel.min.js',
                    'https://scalelot.com/assets/js/magnific-popup/jquery.magnific-popup.min.js',
                    'https://scalelot.com/assets/js/custom.js',
                ],
                CrawlDelay: '5',
